...
const KAKAO_MAP_LINK = "https://map.kakao.com/link/search/서울특별시 은평구 갈현로 121";
      ...
      <div className="px-6 py-12 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="flex items-start gap-4 p-6 rounded-xl border border-gray-100 shadow-sm">
            <div className="mt-0.5 shrink-0" style={iconStyle}>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                서울특별시 은평구 갈현로 121 3층<br />
                <span className="text-xs text-gray-400">(구산동, GS25 건물 3층)</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">010-2833-1054</p>
              <p className="text-xs text-gray-400 mt-0.5">강인원 목사</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                구산중학교·구산초등학교 버스 정류장 하차<br />
                <span className="text-xs text-gray-400">불광역 방면 버스 이용</span>
              </p>
            </div>
          </div>
        </div>
